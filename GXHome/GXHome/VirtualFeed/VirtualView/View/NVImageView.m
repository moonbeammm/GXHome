...
- (void)showImage{
    ...
    if ([self.imgUrl rangeOfString:@"//"].location==NSNotFound) {
        ...
        if ([self.imgUrl isKindOfClass:[NSString class]] && self.imgUrl.length > 0) {
            ...
            [self.imageView gx_setImageWithURL:self.imgUrl completed:^(UIImage * _Nullable image, NSError * _Nullable error, GXWebImageCacheType cacheType, NSURL * _Nullable imageURL) {
